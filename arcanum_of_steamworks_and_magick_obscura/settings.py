...
class GUI:
    ...
    def config_load(self):
        ...
        if not config_parser.has_option('HiRes Patch', 'dialog_font'):
            self.dialog_font = self._("default")
    ...
    def create_main_window(self):
        ...
        label_module = Gtk.Label(
            ...
            label = self._("Module to run at startup:")
            )
        ...
        label_scrolling_distance = Gtk.Label(
            halign = Gtk.Align.START,
            label = self._("Scrolling distance:"),
            )
        ...
        self.checkbutton_no3d = Gtk.CheckButton(
            label = self._("Software rendering mode"),
            halign = Gtk.Align.START,
            name = '-no3d',
            active = self.no3d
            )
        ...
        self.checkbutton_norandom = Gtk.CheckButton(
            label = self._("No random encounters"),
            halign = Gtk.Align.START,
            name = '-norandom',
        ...
        self.checkbutton_msmousez = Gtk.CheckButton(
            label = self._("Alternative mouse wheel behavior"),
            halign = Gtk.Align.START,
            name = '-msmousez',
        ...
        self.checkbutton_mpautojoin = Gtk.CheckButton(
            label = self._("Multiplayer - AutoJoin"),
            halign = Gtk.Align.START,
            name = '-mpautojoin',
        ...
        self.checkbutton_mpnobcast = Gtk.CheckButton(
            label = self._("Multiplayer - NoBroadcast"),
            halign = Gtk.Align.START,
            name = '-mpnobcast',
    ...
    def create_window_hires(self):
        ...
        label_dialog_font = Gtk.Label(
            label = self._("Dialog font: ")
            )
            
        combobox_dialog_font = Gtk.ComboBoxText()
        
        font_size = [self._("default"), '14', '18']
        ...
        checkbutton_larger_logbook_font = Gtk.CheckButton(
            label = self._("Larger logbook font"),
        ...
        checkbutton_compact_opt_screen = Gtk.CheckButton(
            label = self._("Compact options screen"),
            active = self.compact
            )
    ...
    def cb_button_uap(self, button):
        ...
        message_dialog.format_secondary_text(self._("Do not change default installation path"))
        message_dialog.run()
    ...
    def cb_button_patch(self, button):
        ...
        if self.hires_applied == False:
            ...
            if self.dialog_font != self._("default"):
