...
class GUI:
    ...
    def config_load(self):
        ...
        config_file = current_dir + '/game/pop3.ini'
    ...
    def create_main_window(self):
        ...
        self.main_window = Gtk.Window(
            title = _("Prince of Persia: The Two Thrones"),
        ...
        grid.attach(label_fog_bug_fix, 0, 4, 1, 1)
        grid.attach(switch_fog_bug_fix, 1, 4, 2, 1)
